...
const helpCmd = (new Command('risihelp', (params, bot, message) => {
...
const issouCmd = new Command('issou', (params, bot, message) => {
	message.channel.send('AYAAAAA ' + message.author.username )
})

const gangeCmd = new Command('gange', (params, bot, message) => {
	message.channel.send('Purification par le gange en cours...')
}, 'Permet de te purifier grâce à l\'eau du gange')

const pierreCmd = (new Command('pierre', (params, bot, message) => {
